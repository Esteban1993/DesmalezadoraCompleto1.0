...
#define K1              (CtrlPID_TI_K*(1+(CtrlPID_TI_Td/T_VAL)))
#define K2              (-CtrlPID_TI_K*(1+((2*CtrlPID_TI_Td)/T_VAL)-(T_VAL/CtrlPID_TI_Ti)))
#define K3              (CtrlPID_TI_K*(CtrlPID_TI_Td/T_VAL))

/* Variable para la constante proporcional */
static float CtrlPID_TI_K = K_VAL;
/* Variable para el tiempo integrativo */
static float CtrlPID_TI_Ti = TI_VAL;
/* Variable para el tiempo derivativo */
static float CtrlPID_TI_Td = TD_VAL;
/* Variable que almacena los errores */
float CtrlPID_TI_error[2] = {0.0, 0.0};
...
{
  CtrlPID_TI_error[0] = 0.0;
  CtrlPID_TI_error[1] = 0.0;
}
...
void CtrlPID_TI_Control(float error, uint16_t *u)
{
  ...
  ut = (float) *u;
  ut += K1 * error;
  ut += K2 * CtrlPID_TI_error[0];
  ut += K3 * CtrlPID_TI_error[1];

  CtrlPID_TI_error[1] = CtrlPID_TI_error[0];
  CtrlPID_TI_error[0] = error;
