...
**     Date/Time   : 2017-07-18, 16:39, # CodeGen: 39
**     Abstract    :
**          Contains various utility functions.
**     Settings    :
**          Component name                                 : TEXT
**     Contents    :
**         strcpy                - void TEXT_strcpy(byte *dst, size_t dstSize, const unsigned char *src);
**         strcat                - void TEXT_strcat(byte *dst, size_t dstSize, const unsigned char *src);
**         chcat                 - void TEXT_chcat(byte *dst, size_t dstSize, byte ch);
**         Num8sToStr            - void TEXT_Num8sToStr(byte *dst, size_t dstSize, signed char val);
**         Num8uToStr            - void TEXT_Num8uToStr(byte *dst, size_t dstSize, byte val);
**         Num16sToStr           - void TEXT_Num16sToStr(byte *dst, size_t dstSize, int16_t val);
**         Num16uToStr           - void TEXT_Num16uToStr(byte *dst, size_t dstSize, word val);
**         Num32uToStr           - void TEXT_Num32uToStr(byte *dst, size_t dstSize, dword val);
**         Num32sToStr           - void TEXT_Num32sToStr(byte *dst, size_t dstSize, long val);
**         Num16sToStrFormatted  - void TEXT_Num16sToStrFormatted(byte *dst, size_t dstSize, int16_t val, char...
**         Num16uToStrFormatted  - void TEXT_Num16uToStrFormatted(byte *dst, size_t dstSize, word val, char...
**         Num32uToStrFormatted  - void TEXT_Num32uToStrFormatted(byte *dst, size_t dstSize, dword val, char...
**         Num32sToStrFormatted  - void TEXT_Num32sToStrFormatted(byte *dst, size_t dstSize, long val, char...
**         strcatNum8u           - void TEXT_strcatNum8u(byte *dst, size_t dstSize, byte val);
**         strcatNum8s           - void TEXT_strcatNum8s(byte *dst, size_t dstSize, signed char val);
**         strcatNum16u          - void TEXT_strcatNum16u(byte *dst, size_t dstSize, word val);
**         strcatNum16s          - void TEXT_strcatNum16s(byte *dst, size_t dstSize, int16_t val);
**         strcatNum32u          - void TEXT_strcatNum32u(byte *dst, size_t dstSize, dword val);
**         strcatNum32s          - void TEXT_strcatNum32s(byte *dst, size_t dstSize, long val);
**         strcatNum16uFormatted - void TEXT_strcatNum16uFormatted(byte *dst, size_t dstSize, word val, char...
**         strcatNum16sFormatted - void TEXT_strcatNum16sFormatted(byte *dst, size_t dstSize, int16_t val, char...
**         strcatNum32uFormatted - void TEXT_strcatNum32uFormatted(byte *dst, size_t dstSize, dword val, char...
**         strcatNum32sFormatted - void TEXT_strcatNum32sFormatted(byte *dst, size_t dstSize, long val, char...
**         strcatNum8Hex         - void TEXT_strcatNum8Hex(byte *dst, size_t dstSize, byte num);
**         strcatNum16Hex        - void TEXT_strcatNum16Hex(byte *dst, size_t dstSize, word num);
**         strcatNum24Hex        - void TEXT_strcatNum24Hex(byte *dst, size_t dstSize, dword num);
**         strcatNum32Hex        - void TEXT_strcatNum32Hex(byte *dst, size_t dstSize, dword num);
**         IsLeapYear            - bool TEXT_IsLeapYear(word year);
**         WeekDay               - byte TEXT_WeekDay(word year, byte month, byte day);
**         ReadEscapedName       - byte TEXT_ReadEscapedName(const unsigned char *filename, byte *destname,...
**         xatoi                 - byte TEXT_xatoi(const unsigned char **str, long *res);
**         ScanDate              - byte TEXT_ScanDate(const unsigned char **str, byte *day, byte *month, word...
**         ScanTime              - byte TEXT_ScanTime(const unsigned char **str, byte *hour, byte *minute, byte...
**         ScanDecimal8uNumber   - byte TEXT_ScanDecimal8uNumber(const unsigned char **str, byte *val);
**         ScanDecimal16uNumber  - byte TEXT_ScanDecimal16uNumber(const unsigned char **str, word *val);
**         ScanDecimal32uNumber  - byte TEXT_ScanDecimal32uNumber(const unsigned char **str, dword *val);
**         ScanHex8uNumber       - byte TEXT_ScanHex8uNumber(const unsigned char **str, byte *val);
**         ScanHex16uNumber      - byte TEXT_ScanHex16uNumber(const unsigned char **str, word *val);
**         ScanHex32uNumber      - byte TEXT_ScanHex32uNumber(const unsigned char **str, dword *val);
**         strcmp                - int16_t TEXT_strcmp(const char *, const char *);
**         strncmp               - int16_t TEXT_strncmp(const char *, const char *, size_t size);
**         strtailcmp            - byte TEXT_strtailcmp(byte *str, byte *tail);
**         strlen                - word TEXT_strlen(const char *);
**         strCutTail            - byte TEXT_strCutTail(byte *str, byte *tail);
**
...
*/         
/*!
**  @addtogroup TEXT_module TEXT module documentation
**  @{
*/         
...
/*
** ===================================================================
**     Method      :  TEXT_strcpy (component Utility)
**     Description :
...
*/
void TEXT_strcpy(byte *dst, size_t dstSize, const unsigned char *src)
{
...
/*
** ===================================================================
**     Method      :  TEXT_strcat (component Utility)
**     Description :
...
/*!
  ...
  */
void TEXT_strcat(byte *dst, size_t dstSize, const unsigned char *src)
{
  dstSize--; /* for zero byte */
...
/*
** ===================================================================
**     Method      :  TEXT_chcat (component Utility)
**     Description :
...
** ===================================================================
*/
void TEXT_chcat(byte *dst, size_t dstSize, byte ch)
{
  dstSize--; /* for zero byte */
  /* point to the end of the source */
  while (dstSize > 0 && *dst != '\0') {
...
/*
** ===================================================================
**     Method      :  TEXT_Num8uToStr (component Utility)
**     Description :
 ...
 */
void TEXT_Num8uToStr(byte *dst, size_t dstSize, byte val)
{
  TEXT_Num16uToStr(dst, dstSize, (uint16_t)val);
}

/*
** ===================================================================
**     Method      :  TEXT_Num8sToStr (component Utility)
**     Description :
 ...
 */
void TEXT_Num8sToStr(byte *dst, size_t dstSize, signed char val)
{
  TEXT_Num16sToStr(dst, dstSize, (int16_t)val);
}

/*
** ===================================================================
**     Method      :  TEXT_Num16uToStr (component Utility)
**     Description :
 ...
 */
void TEXT_Num16uToStr(byte *dst, size_t dstSize, word val)
{
...
/*
** ===================================================================
**     Method      :  TEXT_Num16sToStr (component Utility)
**     Description :
**         Converts a signed 16bit value into a string.
**     Parameters  :
**         NAME            - DESCRIPTION
 ...
 */
void TEXT_Num16sToStr(byte *dst, size_t dstSize, int16_t val)
{
  unsigned char *ptr =  ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
...
/*
** ===================================================================
**     Method      :  TEXT_Num16sToStrFormatted (component Utility)
**     Description :
...
*/
void TEXT_Num16sToStrFormatted(byte *dst, size_t dstSize, int16_t val, char fill, byte nofFill)
{
  TEXT_Num16sToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  TEXT_Num16uToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void TEXT_Num16uToStrFormatted(byte *dst, size_t dstSize, word val, char fill, byte nofFill)
{
  TEXT_Num16uToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  TEXT_Num32uToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void TEXT_Num32uToStrFormatted(byte *dst, size_t dstSize, dword val, char fill, byte nofFill)
{
  TEXT_Num32uToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  TEXT_Num32sToStrFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Size for the format (right aligned) string, e.g. '2' for "%2d"
*/
void TEXT_Num32sToStrFormatted(byte *dst, size_t dstSize, long val, char fill, byte nofFill)
{
  TEXT_Num32sToStr(dst, dstSize, val);
  ShiftRightAndFill(dst, fill, nofFill);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum8u (component Utility)
**     Description :
...
/*!
  ...
  */
void TEXT_strcatNum8u(byte *dst, size_t dstSize, byte val)
{
  unsigned char buf[sizeof("256")]; /* maximum buffer size we need */

  TEXT_Num8uToStr(buf, sizeof(buf), val);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum8s (component Utility)
**     Description :
...
/*!
  ...
  */
void TEXT_strcatNum8s(byte *dst, size_t dstSize, signed char val)
{
  unsigned char buf[sizeof("-128")]; /* maximum buffer size we need */

  TEXT_Num8sToStr(buf, sizeof(buf), val);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum16u (component Utility)
**     Description :
...
/*!
  ...
  \param[in] val The 16bit unsigned number to add
  */
void TEXT_strcatNum16u(byte *dst, size_t dstSize, word val)
{
  unsigned char buf[sizeof("32768")]; /* maximum buffer size we need */

  TEXT_Num16uToStr(buf, sizeof(buf), val);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum16s (component Utility)
**     Description :
...
/*!
  ...
  \param[in] val The 16bit signed number to add
  */
void TEXT_strcatNum16s(byte *dst, size_t dstSize, int16_t val)
{
  unsigned char buf[sizeof("-32768")]; /* maximum buffer size we need */

  TEXT_Num16sToStr(buf, sizeof(buf), val);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum16uFormatted (component Utility)
**     Description :
...
/*!
  ...
  */
void TEXT_strcatNum16uFormatted(byte *dst, size_t dstSize, word val, char fill, byte nofFill)
{
  unsigned char buf[sizeof("32768")]; /* maximum buffer size we need */

  TEXT_Num16uToStrFormatted(buf, dstSize, val, fill, nofFill);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum16sFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void TEXT_strcatNum16sFormatted(byte *dst, size_t dstSize, int16_t val, char fill, byte nofFill)
{
  unsigned char buf[sizeof("-32768")]; /* maximum buffer size we need */

  TEXT_Num16sToStrFormatted(buf, dstSize, val, fill, nofFill);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum32uFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void TEXT_strcatNum32uFormatted(byte *dst, size_t dstSize, dword val, char fill, byte nofFill)
{
  unsigned char buf[sizeof("4294967295")]; /* maximum buffer size we need */

  TEXT_Num32uToStrFormatted(buf, dstSize, val, fill, nofFill);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum32sFormatted (component Utility)
**     Description :
...
/*!
  ...
  \param[in] nofFill Number of fill characters
  */
void TEXT_strcatNum32sFormatted(byte *dst, size_t dstSize, long val, char fill, byte nofFill)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */

  TEXT_Num32sToStrFormatted(buf, dstSize, val, fill, nofFill);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum8Hex (component Utility)
**     Description :
...
/*!
  ...
  */
void TEXT_strcatNum8Hex(byte *dst, size_t dstSize, byte num)
{
...
/*
** ===================================================================
**     Method      :  TEXT_strcatNum16Hex (component Utility)
**     Description :
...
/*!
  ...
  */
void TEXT_strcatNum16Hex(byte *dst, size_t dstSize, word num)
{
...
/*
** ===================================================================
**     Method      :  TEXT_strcatNum24Hex (component Utility)
**     Description :
...
/*!
  ...
  */
void TEXT_strcatNum24Hex(byte *dst, size_t dstSize, dword num)
{
...
/*
** ===================================================================
**     Method      :  TEXT_strcatNum32Hex (component Utility)
**     Description :
**         Appends a 16bit unsigned value to a buffer as hex number
**         (without a 0x prefix).
**     Parameters  :
...
/*!
  ...
  */
void TEXT_strcatNum32Hex(byte *dst, size_t dstSize, dword num)
{
...
/*
** ===================================================================
**     Method      :  TEXT_strcatNum32s (component Utility)
**     Description :
...
/*!
  ...
  */
void TEXT_strcatNum32s(byte *dst, size_t dstSize, long val)
{
  unsigned char buf[sizeof("-4294967295")]; /* maximum buffer size we need */

  TEXT_Num32sToStr(buf, sizeof(buf), val);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_strcatNum32u (component Utility)
**     Description :
**         Appends a 32bit signed value to a string buffer.
**     Parameters  :
**         NAME            - DESCRIPTION
...
/*!
  ...
  \param[in] val The 32bit unsigned number to add
  */
void TEXT_strcatNum32u(byte *dst, size_t dstSize, dword val)
{
  unsigned char buf[sizeof("4294967295")]; /* maximum buffer size we need */

  TEXT_Num32uToStr(buf, sizeof(buf), val);
  TEXT_strcat(dst, dstSize, buf);
}

/*
** ===================================================================
**     Method      :  TEXT_Num32sToStr (component Utility)
**     Description :
 ...
 */
void TEXT_Num32sToStr(byte *dst, size_t dstSize, long val)
{
  unsigned char *ptr =  ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
...
/*
** ===================================================================
**     Method      :  TEXT_Num32uToStr (component Utility)
**     Description :
 ...
 */
void TEXT_Num32uToStr(byte *dst, size_t dstSize, dword val)
{
  unsigned char *ptr = ((unsigned char *)dst);
  unsigned char i=0, j;
  unsigned char tmp;
...
/*
** ===================================================================
**     Method      :  TEXT_IsLeapYear (component Utility)
**     Description :
...
** ===================================================================
*/
bool TEXT_IsLeapYear(word year)
{
...
/*
** ===================================================================
**     Method      :  TEXT_WeekDay (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_WeekDay(word year, byte month, byte day)
{
  ...
  sum += sum/4;
  sum %= 7;
  if (TEXT_IsLeapYear(year) && (month==1 || month==2)) {
    sum--;
  }
  sum += day;
  sum %= 7;
...
/*
** ===================================================================
**     Method      :  TEXT_ReadEscapedName (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_ReadEscapedName(const unsigned char *filename, byte *destname, size_t maxlen, size_t *lenRead, size_t *lenWritten, const char *terminators)
{
...
/*
** ===================================================================
**     Method      :  TEXT_xatoi (component Utility)
**     Description :
...
#endif
byte TEXT_xatoi(const unsigned char **str, long *res)
{
...
/*
** ===================================================================
**     Method      :  TEXT_ScanDate (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_ScanDate(const unsigned char **str, byte *day, byte *month, word *year)
{
  ...
  if (   TEXT_ScanDecimal8uNumber(&p, day)==ERR_OK
      && *day > 0 && *day <= 31
      && (*p=='.' || *p=='-')
     )
  {
    p++;
    if (   TEXT_ScanDecimal8uNumber(&p, month)==ERR_OK
        && *month > 0 && *month <= 12
        && (*p=='.' || *p=='-')
       )
    {
      p++;
      if (   TEXT_ScanDecimal16uNumber(&p, year)==ERR_OK
...
/*
** ===================================================================
**     Method      :  TEXT_ScanTime (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_ScanTime(const unsigned char **str, byte *hour, byte *minute, byte *second, byte *hSecond)
{
  ...
  *hSecond = 0;
  ...
  if (   TEXT_ScanDecimal8uNumber(&p, hour)==ERR_OK
      && *hour <= 24
      && *p==':'
     )
  {
    p++; /* skip ':' */
    if (   TEXT_ScanDecimal8uNumber(&p, minute)==ERR_OK
        && *minute <= 60
        && *p==':'
       )
    {
      p++; /* skip ':' */
      if (   TEXT_ScanDecimal8uNumber(&p, second)==ERR_OK
          && *second <= 60
         )
      {
...
/*
** ===================================================================
**     Method      :  TEXT_ScanDecimal16uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_ScanDecimal16uNumber(const unsigned char **str, word *val)
{
...
/*
** ===================================================================
**     Method      :  TEXT_ScanDecimal8uNumber (component Utility)
**     Description :
**         Scans a decimal 16bit unsigned number
**     Parameters  :
**         NAME            - DESCRIPTION
...
** ===================================================================
*/
byte TEXT_ScanDecimal8uNumber(const unsigned char **str, byte *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  TEXT_ScanDecimal32uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_ScanDecimal32uNumber(const unsigned char **str, dword *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  TEXT_strcmp (component Utility)
**     Description :
...
*/
/***
int16_t TEXT_strcmp(const char *, const char *)
{
...
/*
** ===================================================================
**     Method      :  TEXT_strncmp (component Utility)
**     Description :
...
*/
/***
int16_t TEXT_strncmp(const char *, const char *, size_t size)
{
...
/*
** ===================================================================
**     Method      :  TEXT_strlen (component Utility)
**     Description :
...
/*
** ===================================================================
**     Method      :  TEXT_ScanHex32uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_ScanHex32uNumber(const unsigned char **str, dword *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  TEXT_ScanHex16uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_ScanHex16uNumber(const unsigned char **str, word *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  TEXT_ScanHex8uNumber (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_ScanHex8uNumber(const unsigned char **str, byte *val)
{
  /* scans a decimal number, and stops at any non-number. Number can have any preceding zeros or spaces. */
...
/*
** ===================================================================
**     Method      :  TEXT_strtailcmp (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_strtailcmp(byte *str, byte *tail)
{
  int i, j;

  i = (int)TEXT_strlen((char*)str);
  j = (int)TEXT_strlen((char*)tail);
...
/*
** ===================================================================
**     Method      :  TEXT_strCutTail (component Utility)
**     Description :
...
** ===================================================================
*/
byte TEXT_strCutTail(byte *str, byte *tail)
{
  /* cut the tail from the string */
  size_t strLen, tailLen;

  if (TEXT_strtailcmp(str, tail)!=0) { /* check if tail is present */
    return ERR_FAILED; /* tail not found */
  }
  tailLen = TEXT_strlen((char*)tail);
  strLen = TEXT_strlen((char*)str);
